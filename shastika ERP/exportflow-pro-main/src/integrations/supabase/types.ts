  ...
  public: {
    Tables: {
      ...
      employee_productivity_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_productivity_metrics_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "employee_productivity_metrics_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
      ...
      employee_attendance_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_attendance_records_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "employee_attendance_records_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      employee_task_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_task_history_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "employee_task_history_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      shipment_containers: {
        ...
        Relationships: [
          {
            foreignKeyName: "shipment_containers_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
