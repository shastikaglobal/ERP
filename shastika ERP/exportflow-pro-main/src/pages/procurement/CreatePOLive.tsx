  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-sm text-muted-foreground">Loading purchase order form…</div>
      </div>
    );
  }
      ...
      <div>
        ...
        <Section title="Missing company context">
          <p className="text-sm text-muted-foreground">
            Your account is not assigned to a company yet. Purchase order creation requires a company assignment.
