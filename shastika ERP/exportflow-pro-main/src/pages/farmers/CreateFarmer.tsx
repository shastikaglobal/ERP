  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-sm text-muted-foreground">Loading farmer form…</div>
      </div>
    );
  }
      ...
      <div>
        ...
        <Section title="Missing company context">
          <p className="text-sm text-muted-foreground">
            Your account is not assigned to a company yet. Farmer creation requires a company assignment.
